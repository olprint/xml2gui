...
* [x] Python ![Python 3.12 64 bit](https://img.shields.io/badge/v3.12-64bit-229342)
    ...
    ~~![Python 3.12 32 bit](https://img.shields.io/badge/v3.12-32bit-FFFFFF)
    ![Python 3.11 32 bit](https://img.shields.io/badge/v3.11-32bit-FFFFFF)
    ![Python 3.10 32 bit](https://img.shields.io/badge/v3.10-32bit-FFFFFF)
    ![Python 3.9 32 bit](https://img.shields.io/badge/v3.9-32bit-FFFFFF)
    ![Python 3.8 32 bit](https://img.shields.io/badge/v3.8-32bit-FFFFFF)
    ![Python 3.7 32 bit](https://img.shields.io/badge/v3.7-32bit-FFFFFF)
    ![Python 3.6 32 bit](https://img.shields.io/badge/v3.6-32bit-FFFFFF)~~
